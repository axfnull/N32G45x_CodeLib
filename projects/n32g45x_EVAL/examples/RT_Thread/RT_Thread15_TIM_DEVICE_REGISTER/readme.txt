...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行
         2. 本例程在main()里面创建两个线程，test0 线程和 test1 线程，test0 线程用于控制 D6 500ms闪烁，在test1线程中测试 TIM1，5秒定时，调用回调函数，可通过串口查看打印信息
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
        ...
        2. This routine creates two threads in main(), test0 thread and test1 thread, test0 thread is used to control D6 500ms flashing, test TIM1 in test1 thread, 
